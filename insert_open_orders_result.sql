-- ============================================================
-- 在手订单结果表 INSERT 语句
-- 源表: dwd_load.open_orders
-- 目标表: jst_flat.open_orders_result
-- 说明: 取数逻辑与 sales_orders_result 一致，仅源表不同
-- ============================================================

INSERT INTO jst_flat.open_orders_result (
...
SELECT
  ...
  -- ========== 销售组织描述: 通过(系统标识+销售组织=cbukrs)关联ztbpc002_com取cbuktx ==========
